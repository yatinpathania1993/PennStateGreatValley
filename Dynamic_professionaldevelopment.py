...
data_dir = os.path.join(base_dir, "Static/professional_development")
excel_file_path = os.path.join(base_dir, "data_Updated.xlsx")
output_excel_path = os.path.join(base_dir, "scraped_data_with_hash_professional_development.xlsx")
...
pages_to_crawl_df = pd.read_excel(excel_file_path, sheet_name="Sheet3")
...
updated_pages_output_path = os.path.join(base_dir, "updated_pages_professional_development.xlsx")
