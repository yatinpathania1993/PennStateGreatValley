...
data_dir = os.path.join(base_dir, "Static/Information_For")
excel_file_path = os.path.join(base_dir, "data_Updated.xlsx")
output_excel_path = os.path.join(base_dir, "scraped_data_with_hash_Information_For.xlsx")
...
pages_to_crawl_df = pd.read_excel(excel_file_path, sheet_name="Sheet4")
...
updated_pages_output_path = os.path.join(base_dir, "updated_pages_Infromation_For.xlsx")
